            ...
            <div class="col-md-6">
                ...
                <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" name="is_admin" id="is_admin"
                           value="1" <?php echo e(old('is_admin') ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                ...
                <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" name="ativo" id="ativo"
                           value="1" <?php echo e(old('ativo', true) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                       name="cargo" value="<?php echo e(old('cargo')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                       name="registro_profissional" value="<?php echo e(old('registro_profissional')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                       name="telefone" value="<?php echo e(old('telefone')); ?>" maxlength="20">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\joaor\OneDrive\Documentos\php\descontaminacao\resources\views/users/create.blade.php ENDPATH**/ ?>