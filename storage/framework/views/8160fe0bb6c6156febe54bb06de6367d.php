...
<?php $__env->startSection('title', 'Novo Equipamento de Medição'); ?>
<?php $__env->startSection('page-title', 'Novo Equipamento de Medição'); ?>
...
<div class="card-modern" style="max-width: 640px">
    <form method="POST" action="<?php echo e(route('equipamentos_medicao.store')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="detector" <?php echo e(old('tipo') === 'detector' ? 'selected' : ''); ?>>Detector de Gases</option>
                    <option value="explosimetro" <?php echo e(old('tipo') === 'explosimetro' ? 'selected' : ''); ?>>Explosímetro</option>
                    <option value="oximetro" <?php echo e(old('tipo') === 'oximetro' ? 'selected' : ''); ?>>Oxímetro</option>
                </select>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('numero_serie')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('data_calibracao')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\joaor\OneDrive\Documentos\php\descontaminacao\resources\views/equipamentos_medicao/create.blade.php ENDPATH**/ ?>