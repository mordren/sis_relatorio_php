...
@section('page-title', 'Editar Equipamento de Medição')
...
<div class="card-modern" style="max-width: 640px">
    <form method="POST" action="{{ route('equipamentos_medicao.update', $equipamento) }}">
        @csrf @method('PUT')
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="data_calibracao" class="form-control @error('data_calibracao') is-invalid @enderror"
                       value="{{ old('data_calibracao', $equipamento->data_calibracao?->format('Y-m-d')) }}">
