...
<head>
    ...
    <title>@yield('title', 'Dashboard') - {{ config('app.name', 'Descontaminação') }}</title>

    {{-- Bootstrap 5 + Ícones --}}
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">

    {{-- Flatpickr (date picker br) --}}
...
<div class="app-wrapper">
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <a href="{{ Route::has('dashboard') ? route('dashboard') : url('/') }}" class="logo">
        ...
        <ul class="sidebar-nav nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('clientes.*') ? 'active' : '' }}" href="{{ route('clientes.index') }}">
                    <i class="bi bi-people-fill"></i>
                    <span>Clientes</span>
                </a>
            </li>
            @elseif(Route::has('clientes.create'))
            <li class="nav-item">
                <a class="nav-link {{ Route::is('clientes.*') ? 'active' : '' }}" href="{{ route('clientes.create') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('veiculos.*') ? 'active' : '' }}" href="{{ route('veiculos.index') }}">
                    <i class="bi bi-truck"></i>
                    <span>Veículos</span>
                </a>
            </li>
            @elseif(Route::has('veiculos.create'))
            <li class="nav-item">
                <a class="nav-link {{ Route::is('veiculos.*') ? 'active' : '' }}" href="{{ route('veiculos.create') }}">
                    <i class="bi bi-truck"></i>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('relatorios.*') ? 'active' : '' }}" href="{{ route('relatorios.index') }}">
                    <i class="bi bi-file-earmark-text-fill"></i>
                    <span>Relatórios</span>
                </a>
            </li>
            @elseif(Route::has('relatorios.create'))
            <li class="nav-item">
                <a class="nav-link {{ Route::is('relatorios.*') ? 'active' : '' }}" href="{{ route('relatorios.create') }}">
...
{{-- Footer fora do wrapper para manter alinhamento --}}
<footer class="app-footer">
    <div class="d-flex justify-content-between">
        <span>&copy; {{ date('Y') }} {{ config('app.name', 'Descontaminação') }}. Todos os direitos reservados.</span>
        <span><i class="bi bi-droplet"></i> Sistema de Descontaminação</span>
    </div>
</footer>

@else
    {{-- Conteúdo para visitantes não autenticados (login, etc) --}}
    <main class="py-5">
        <div class="container">
            @yield('content')
        </div>
